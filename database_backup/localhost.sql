...
--
-- Хост: localhost:3306
-- Время создания: Ноя 26 2020 г., 10:40
...
(2, 56.8280325, 60.617249, 'ИЕНиМ', 2, 'Это - институт естеств. наук и математики =)', 2, 0),
(3, 56.8404446, 60.6137215, 'УГИ', 3, 'Это - университет гуманитариев =)', 3, 0),
...
(15, 56.8172067, 60.6134809, 'ИнЭУ', 15, 'Это - институт экономики и управления', 15, 0),
(16, 56.8317602, 60.6087875, 'ВШЭМ', 16, 'Это - высшая школа экономики и менеджмента', 16, 0),
(17, 56.8373599, 60.5880323, 'ИнЭУ', 17, 'Это - институт экономики и управления', 17, 0),
(18, 56.8407304, 60.614028, 'ИЕНиМ (матмех)', 18, 'Это - институт экономики и управления', 18, 0);
