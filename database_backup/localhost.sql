...
--
-- Хост: localhost:3306
-- Время создания: Дек 07 2020 г., 12:45
...
(5, 56.843013, 60.652508, 'ИнЭУ(И)', 'Это - высшая школа экономики и менеджмента', 0, '', 'ул. Мира, 19', 'Пн-пт 08:30 – 19:00\\nСб 8:30 – 16:00\\nКонтакт-центр: 8-800-100-50-44', 'https://urfu.ru/ru/'),
...
(15, 56.83174850995216, 60.61083336021693, 'ИнЭУ(И2)', 'Это - институт экономики и управления', 0, '', 'ул. Гоголя, 25', 'Пн-пт 08:00 – 22:00\\n8-800-234-95-56, +7 (343) 371-10-03', 'https://gsem.urfu.ru/ru/'),
...
(17, 56.837221, 60.590116, 'ИнЭУ(центр)', 'Это - институт экономики и управления', 0, '', 'пр. Ленина, 13Б', 'Пн-пт 08:00 – 22:00\\n8-800-234-95-56, +7 (343) 371-10-03', 'https://gsem.urfu.ru/ru/'),
...
(22, 56.839334, 60.657548, 'Зал бокса и тяжелой атлетики', 'Бокс, тяжелая атлетика', 1, '', 'ул. Малышева, 138А', '', ''),
(23, 56.837372, 60.655145, 'Бассейн УрФУ', 'Плавание', 1, '', 'ул. Коминтерна, 14а', '+7 343 375-93-84', ''),
(24, 56.83767, 60.654898, 'СКИВС', 'Баскетбол, мини-футбол, волейбол, гандбол', 1, '', 'ул. Коминтерна, 14', '', ''),
(25, 56.836584, 60.654922, 'Бизнес-центр им. Б.Н. Ельцина', 'Дзюдо, самбо, большой теннис', 1, '', 'ул. Коминтерна, 16', '', ''),
(26, 56.838514, 60.656278, 'Студенческий центр \"Звездный\"', 'Фитнес', 1, '', 'ул. Фонвизина, 1/3', '', ''),
